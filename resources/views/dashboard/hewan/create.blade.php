            ...
            <form action ="/hewan" method="post">
                ...
                <div class="card">
                    <div class="card-header text-center">
                        Form Insert Data Hewan
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                            <label for="nama_hewan" class="form-label">Nama Hewan</label>
                            <input type="text" name="nama_hewan" id="nama_hewan" placeholder="nama_hewan" class="form-control @error('nama_hewan') is-invalid @enderror" value="{{ old('nama_hewan') }}">
                            @error('nama_hewan')
                    ...
                    <label for="nama_hewan" class="form-label">Owner</label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="tanggal_masuk" id="tanggal_masuk" placeholder="Tanggal Masuk" class="form-control @error('tanggal_masuk') is-invalid @enderror" value="{{ old('tanggal_masuk') }}">
                            @error('tanggal_masuk')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
